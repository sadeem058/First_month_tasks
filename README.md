...
This base model was printed while preserving the original **length and width** with no changes applied to its outer dimensions.  
The only modification performed was a **bottom carving (hollowing)** using the **Shell** tool to reduce material usage.
